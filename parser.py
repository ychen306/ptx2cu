...
class Statement(ABC):
    '''Base class for top-level things like memory decl, entry, and opaque directives'''
...
class InstructionBase(BlockItem):
    """Placeholder for a PTX instruction."""
...
class MemoryRef(Operand):
    # base refers to either a register or a parameter symbol
